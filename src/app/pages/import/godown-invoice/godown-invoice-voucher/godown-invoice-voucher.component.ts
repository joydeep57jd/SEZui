...
@Component({
  selector: 'app-godown-invoice-voucher',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './godown-invoice-voucher.component.html',
  styleUrls: ['./godown-invoice-voucher.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class GodownInvoiceVoucherComponent {
